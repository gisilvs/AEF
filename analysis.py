...
def denoising_plot(df):
    ...
    for dataset in datasets:
        ...
        df_to_use = df_to_use.replace(to_replace={'ae': "AE", 'vae-iaf-maf': "VAE-IAF-MAF", 'nae-external': 'AEF (linear)'})
        ...
        plt.savefig(f'plots/denoising_{dataset}.pdf', bbox_inches='tight')
